	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">,Jalgaon, Maharashtra, Pin -425001</p>
					<p class="lead"><a href="#">+91 9011115729</a></p>
					<p><a href="#"> chetanpatil@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2020 <a href="#">Patil Restaurant</a> Developed By : Chetan Patil
					<a href=""></a><br>
