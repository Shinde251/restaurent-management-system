		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Patil Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Patil Restaurant is serving a Authentic Kathiyawadi Food.And Restaurant's 
<br> 
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Patil Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>jlagaon maharashtra 425001, 
 </p>
						<p>jalgaon</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Patil Restaurent</span>
				</div>
			</div>
		</div>
	</div>
